      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        {isAuthenticated && hasDeployedProfile && deployedUsername ? (
          ...
          <>
            ...
            {/* Input Field */}
            <div
              className={`flex flex-col sm:flex-row items-center justify-center gap-3 max-w-2xl mx-auto transition-all duration-1000 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                isVisible
              ...
              >
                ...
                <Input
                  ...
                  className={`w-full pr-4 py-6 text-lg rounded-full border-2 transition-all duration-300 ${
                    inputMode === 'claim' ? 'pl-[16rem]' : 'pl-[6.5rem]'
                  } ${
                    isInputFocused
